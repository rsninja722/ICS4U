...
public class Input {
    ...
    public static void init() {
        ...
        Draw.panel.addMouseWheelListener(new MouseWheelListener() {
    ...
    public static void setMousePosition(int x, int y) {
        if (Draw.drawingMode == 0) {
            ...
            double xoff = GameJava.gw / 2;
            double yoff = GameJava.gh / 2;
            Point tempPos = new Point((int) ((x - xoff) / Camera.zoom + xoff) - Camera.x,
                    (int) ((y - yoff) / Camera.zoom + yoff) - Camera.y);
